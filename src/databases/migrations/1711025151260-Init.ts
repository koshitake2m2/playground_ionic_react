...
export class Init1711025151260 implements MigrationInterface {
  name = 'Init1711025151260'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
        ...
        `)
    await queryRunner.query(`
            INSERT INTO "temporary_post"("id", "title", "text", "authorId")
            SELECT "id",
                "title",
                "text",
                "authorId"
    ...
    await queryRunner.query(`
        ...
        `)
    await queryRunner.query(`
            CREATE TABLE "temporary_post_categories_category" (
                "postId" integer NOT NULL,
                "categoryId" integer NOT NULL,
        ...
        `)
    await queryRunner.query(`
            INSERT INTO "temporary_post_categories_category"("postId", "categoryId")
            SELECT "postId",
                "categoryId"
            FROM "post_categories_category"
        `)
    await queryRunner.query(`
            DROP TABLE "post_categories_category"
        `)
    await queryRunner.query(`
            ALTER TABLE "temporary_post_categories_category"
                RENAME TO "post_categories_category"
        `)
    await queryRunner.query(`
            CREATE INDEX "IDX_93b566d522b73cb8bc46f7405b" ON "post_categories_category" ("postId")
        `)
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
            ALTER TABLE "post_categories_category"
                RENAME TO "temporary_post_categories_category"
        `)
    await queryRunner.query(`
            CREATE TABLE "post_categories_category" (
                "postId" integer NOT NULL,
        ...
        `)
    await queryRunner.query(`
            INSERT INTO "post_categories_category"("postId", "categoryId")
            SELECT "postId",
                "categoryId"
            FROM "temporary_post_categories_category"
        `)
    await queryRunner.query(`
            DROP TABLE "temporary_post_categories_category"
        `)
    await queryRunner.query(`
            CREATE INDEX "IDX_a5e63f80ca58e7296d5864bd2d" ON "post_categories_category" ("categoryId")
        `)
    ...
    await queryRunner.query(`
        ...
        `)
    await queryRunner.query(`
            INSERT INTO "post"("id", "title", "text", "authorId")
            SELECT "id",
                "title",
                "text",
                "authorId"
